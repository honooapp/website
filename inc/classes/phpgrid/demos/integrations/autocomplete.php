...
$col["formatoptions"] = array(	"sql"=>"SELECT client_id as k, name as v FROM clients",
								"search_on"=>"name", 
								"update_field" => "client_id");

// for distinct values, try group by trick
// $col["formatoptions"] = array(    
// 								"sql"=>"SELECT * FROM (SELECT client_id as k, name as v FROM clients GROUP BY name) o",
//                                 "search_on"=>"v", 
//                                 "update_field" => "id");
